...
while user_choice != "xxx":
    ...
    user_choice = choice_checker("Choose rock / paper / scissors (r/p/s): " , "Please choose from rock / paper / scissors (or xxx to quit") #  Ask for user to input choice, then check if valid
